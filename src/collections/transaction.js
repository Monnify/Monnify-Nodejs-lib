...
export class Transaction extends BaseRequestAPI {
  ...
  async getTransactionStatusv2(authToken, data) {
    ...
    const result = getTransactionStatusv2Schema.validate(data, {
      allowUnknown: true,
    });
  ...
  async getTransactionStatusv1(authToken, data) {
    ...
    const result = getTransactionStatusv1Schema.validate(data, {
      allowUnknown: true,
    });
  ...
  async payWithBankTransfer(authToken, data) {
    ...
    const result = payWithBankTransferSchema.validate(data, {
      allowUnknown: true,
    });
  ...
  async ThreeDsSecureAuthTransaction(authToken, data) {
    ...
    const result = ThreeDSAuthTransactionSchema.validate(data, {
      allowUnknown: true,
    });
